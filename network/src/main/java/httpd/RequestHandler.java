...
public class RequestHandler extends Thread {
	...
	public void run() {
		try {
			...
			if("GET".equals(tokens[0])) {
				resposeStaticResource(outputStream, tokens[1], tokens[2]);
			} else {
	...
	private void resposeStaticResource(OutputStream outputStream, String url, String protocol) throws IOException {
